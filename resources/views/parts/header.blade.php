...
<!--  <a class="navbar-brand text-white" href="/">P! note</a>-->
...
<!--        <a href="#" class="nav-link dropdown-toggle text-white" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">TOP</a>-->
<!--      </li>-->
