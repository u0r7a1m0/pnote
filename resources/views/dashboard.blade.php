        ...
        <div class="d-flex flex-wrap text-gray-700 text-left bg-blue-100 px-4 py-2 m-2">
            <a href="/notes/">
                <div class="card m-2" style="width: 18rem;">
                    <img src="{{ asset('storage/images/book02.jpg') }}" class="card-img-top">
            ...
            <a href="/notes/create">
                <div class="card m-2" style="width: 18rem;">
                    <img src="{{ asset('storage/images/book04.jpg') }}" class="card-img-top">
            ...
            <a href="/tags.create">
                <div class="card m-2" style="width: 18rem;">
                    <img src="{{ asset('storage/images/tag01.jpg') }}" class="card-img-top">
